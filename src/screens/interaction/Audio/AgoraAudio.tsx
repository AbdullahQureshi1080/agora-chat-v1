...
import styles from './AgoraAudioStyles';
...
export default function AgoraAudio({route}) {
    ...
    try {
      ...
      agoraEngine.registerEventHandler({
        ...
        onUserMuteAudio(connection, remoteUid, muted) {
          console.log('OnMUTE', connection, remoteUid, muted);
          // setMute(muted);
          if (fUserId == remoteUid) {
            setMute(muted);
          }
        },
      });
      ...
      //   encryptionBase64: AppConfig.encryptionSaltBase64,
  ...
  return (
    <Screen isBack={true} navigation={navigation}>
      ...
      <View style={styles.btnContainer}>
        <View>
          <Text style={styles.head}>Audio Calling</Text>
